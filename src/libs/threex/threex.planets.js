...
THREEx.Planets.baseURL	= '../planet-geo/src/assets/textures/'
...
THREEx.Planets.createMercury	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map	: new THREE.TextureLoader().load(THREEx.Planets.baseURL+'mercurymap.jpg'),
		bumpMap	: new THREE.TextureLoader().load(THREEx.Planets.baseURL+'mercurybump.jpg'),
		bumpScale: 0.005,
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh	
...
THREEx.Planets.createEarth	= function(){
	...
	var material	= new THREE.MeshPhongMaterial({
		map		: new THREE.TextureLoader().load(THREEx.Planets.baseURL+'world-big.jpg'),
		bumpMap		: new THREE.TextureLoader().load(THREEx.Planets.baseURL+'world-big.jpg'),
		bumpScale	: 0.05,
		shininess: 100,
    	shading: THREE.SmoothShading,
		specularMap	: new THREE.TextureLoader().load(THREEx.Planets.baseURL+'world-big.jpg'),
...
THREEx.Planets.createMars	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map	: new THREE.TextureLoader().load(THREEx.Planets.baseURL+'marsmap1k.jpg'),
...
THREEx.Planets.createSaturnRing	= function(){
	...
	var material	= new THREE.MeshPhongMaterial({
		map		: new THREE.Texture(canvasResult),
		// map		: new THREE.TextureLoader().load(THREEx.Planets.baseURL+'ash_uvgrid01.jpg'),
		side		: THREE.DoubleSide,
		transparent	: true,
		opacity		: 0.8,
	})
...
THREEx.Planets.createPluto	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map	: new THREE.TextureLoader().load(THREEx.Planets.baseURL+'plutomap1k.jpg'),
		bumpMap	: new THREE.TextureLoader().load(THREEx.Planets.baseURL+'plutobump1k.jpg'),
		bumpScale: 0.005,
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh	
